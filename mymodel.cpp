...
//    students = new QList<Student*>();
    Movie* mv1 = new Movie("1","Король Лев","Приключения", "1994", "Роджер Аллерс", "0+", this);
    Movie* mv2 = new Movie("2","Властелин колец: Братство Кольца","Фэнтези", "2001", "Питер Джексон", "12+", this);
    Movie* mv3 = new Movie("3","Начало","Триллер", "2010", "Кристофер Нолан", "12+", this);
    AddMovie(mv1);
    AddMovie(mv2);
    AddMovie(mv3);
}
